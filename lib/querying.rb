...
def select_character_names_and_number_of_books_they_are_in
  "SELECT name COUNT(name) FROM character_books INNER JOIN characters ON characters.id = character_books.character_id GROUP BY characters.name ORDER BY COUNT(name) DESC"
end
